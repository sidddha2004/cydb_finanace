...
This guide explains how to run Sentinel AI locally using your original (non-containerized backend) while using Docker only for infrastructure services (Kafka, Redis, CyborgDB).
